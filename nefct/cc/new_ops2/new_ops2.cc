...
public:
	...
	void Compute(OpKernelContext *context) override
	{
        ...
        const Tensor &ai = context->input(3);
        const Tensor &bi = context->input(4);

		auto image_flat = image.flat<float>();
		auto angles_flat = angles.flat<float>();
		auto offsets_flat = offsets.flat<float>();
        auto ai_flat = ai.flat<float>();
        auto bi_flat = bi.flat<float>();
...
public:
	...
	void Compute(OpKernelContext *context) override
	{
        ...
        const Tensor &ai = context->input(4);
        const Tensor &bi = context->input(5);
...
public:
	...
	void Compute(OpKernelContext *context) override
	{
		...
		const Tensor &ax = context->input(5);
		const Tensor &ay = context->input(6);
		const Tensor &az = context->input(7);
		const Tensor &bx = context->input(8);
		const Tensor &by = context->input(9);
		const Tensor &bz = context->input(10);
		const Tensor &cx = context->input(11);
		const Tensor &cy = context->input(12);
		const Tensor &cz = context->input(13);
		const Tensor &v_data = context->input(14);
		const Tensor &f_data = context->input(15);
...
public:
	...
	void Compute(OpKernelContext *context) override
	{
        ...
        const Tensor &ai = context->input(4);
        const Tensor &bi = context->input(5);
		const Tensor &ax = context->input(6);
		const Tensor &ay = context->input(7);
		const Tensor &az = context->input(8);
		const Tensor &bx = context->input(9);
		const Tensor &by = context->input(10);
		const Tensor &bz = context->input(11);
		const Tensor &cx = context->input(12);
		const Tensor &cy = context->input(13);
		const Tensor &cz = context->input(14);
		const Tensor &v_data = context->input(15);
		const Tensor &f_data = context->input(16);
        const Tensor &v0_data = context->input(17);
		const Tensor &f0_data = context->input(18);
		const Tensor &num_in_bin = context->input(19);
