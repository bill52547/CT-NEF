...
deform_tex_module = tf.load_op_library(
    '/home/bill52547/Github/tensorflow/bazel-bin/tensorflow/core/user_ops/tf_deform_tex_module.so'
)

deform_2d_tex_module = tf.load_op_library(
    '/home/bill52547/Github/tensorflow/bazel-bin/tensorflow/core/user_ops/tf_deform_2d_tex_module.so'
)
